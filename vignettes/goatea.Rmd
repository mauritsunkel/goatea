...
knitr::opts_chunk$set(
  ...
  fig.align = "center")
```
```{r lightbox, echo=FALSE, results='asis'}
cat('
<style>
.fullscreen-overlay {
...
<div id="img-overlay" class="fullscreen-overlay" onclick="this.classList.remove(\'active\')">
  <img id="img-overlay-src" src="" />
</div>
<script>
document.addEventListener("click", function(e) {
  if (e.target.tagName === "IMG" && e.target.closest(".figure, p")) {
    document.getElementById("img-overlay-src").src = e.target.src;
...
For an application demonstration, see the `r BiocStyle::vignette_url("goatea_GUI", label = "GUI vignette")`
