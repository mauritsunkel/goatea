...
![Alt text for accessibility](images/GOATEA_GUI_load_data.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_question_button.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_navigation_buttons.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_volcano.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_overlap.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_enrichment.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_splitdot.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_termtree.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_heatmap_gene_genesets.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_heatmap_gene_genesets_selected.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_heatmap_gene_effectsize.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_heatmap_gene_effectsize_selected.png){width=80%}
...
![Alt text for accessibility](images/GOATEA_GUI_PPI.png){width=80%}

Selections can then be subgraphed for zoomed inspection. 

![Alt text for accessibility](images/GOATEA_GUI_PPI_selected.png){width=80%}

FYI, graph edges can be clicked to inspect their STRING database interaction information.

![Alt text for accessibility](images/GOATEA_GUI_PPI_STRINGdb.png){width=80%}
