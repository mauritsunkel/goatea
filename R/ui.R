        ...
        tabItem(tabName = "menu_initialize",
                fluidRow(
                  box(
                    ...
                    width = NULL,
                    column(width = 3, wrap_hovertip(selectInput("si_organism", "Select organism",
                    ...
                    column(width = 3, wrap_hovertip(radioButtons("rb_global_output_type", "Select output type",
        ...
        tabItem(tabName = "menu_plot_PPI",
                fluidRow(
                  box(
                    ...
                    # TODO server
                    # TODO clone ui/server to _subgraph
                    fluidRow(
                      column(width = 2, wrap_hovertip(actionButton("ab_ppi_highlight_nodes", "Highlight feature by filter"),
                    ...
                    fluidRow(
                      column(width = 2, wrap_hovertip(actionButton("ab_ppi_highlight_gene", "Highlight input protein"),
                                                      hovertip = "Highlight textinput protein to the right")),
                      column(width = 2, wrap_hovertip(textInput("ti_ppi_highlight_gene", "input protein"),
                                                      hovertip = "Gene to highlight")),
                      column(width = 2, wrap_hovertip(actionButton("ab_ppi_highlight_cluster", "Highlight input cluster"),
                                                      hovertip = "Highlight genes by selecting cluster to the right")),
                      column(width = 2, wrap_hovertip(selectInput("si_ppi_highlight_cluster", "input cluster", choices = NULL),
                    ...
                    column(width = 10, verbatimTextOutput("vto_ppi_metrics")),
                    ...
                    column(width = 2),
                    column(width = 2),
                    column(width = 2, wrap_hovertip(actionButton("ab_ppi_highlight_gene_subgraph", "Highlight input protein"),
                                                    hovertip = "Highlight textinput protein to the right")),
                    column(width = 2, wrap_hovertip(textInput("ti_ppi_highlight_gene_subgraph", "input protein"),
                                                    hovertip = "Gene to highlight")),
                    column(width = 2, wrap_hovertip(actionButton("ab_ppi_highlight_cluster_subgraph", "Highlight input cluster"),
                                                    hovertip = "Highlight genes by selecting cluster to the right")),
                    column(width = 2, wrap_hovertip(selectInput("si_ppi_highlight_cluster_subgraph", "input cluster", choices = NULL),
                                                    hovertip = "Cluster to highlight")),
